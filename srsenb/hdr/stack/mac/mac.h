...
public:
  ...
  int snr_info(uint32_t tti, uint16_t rnti, uint32_t enb_cc_idx, float snr, float snr_custom, ul_channel_t ch) override;
  ...
  int crc_info(uint32_t tti, uint16_t rnti, uint32_t enb_cc_idx, uint32_t nof_bytes, bool crc_res, bool orig_crc) override;

...
public:
  ...
  explicit tpc(uint16_t rnti_,
    ...
    snr_estim_list(
        {ul_ch_snr_estim{ul_snr_avg_alpha, init_ul_snr_value, init_ul_snr_value}, ul_ch_snr_estim{ul_snr_avg_alpha, init_ul_snr_value, init_ul_snr_value}}),
  ...
  void set_snr(float snr, float snr_custom, uint32_t ul_ch_code)
  {
...
private:
  ...
  struct ul_ch_snr_estim {
    ...
    explicit ul_ch_snr_estim(float exp_avg_alpha, int initial_snr, int initial_snr_custom) :

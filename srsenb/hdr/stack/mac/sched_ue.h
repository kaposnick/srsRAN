...
public:
  ...
  void set_ul_snr(tti_point tti_rx, uint32_t enb_cc_idx, float snr, float noise, float snr_custom, uint32_t ul_ch_code);
  ...
  void set_ul_crc(tti_point tti_rx, uint32_t enb_cc_idx, bool crc_res, bool orig_crc_res);

...
void sched_ue::set_ul_snr(tti_point tti_rx, uint32_t enb_cc_idx, float snr, float snr_custom, uint32_t ul_ch_code)
{
  cells[enb_cc_idx].set_ul_snr(tti_rx, snr, snr_custom, ul_ch_code);
}
